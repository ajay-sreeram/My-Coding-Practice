...
{
keytomatrix(key,len);
int d=Math.abs(determinant(keymatrix,len));
d=d%26;
if(d==0)
{
...
//else if(d%2==0||d==13||d==1)
{
System.out.println("Invalid key!!! Key is not invertible because determinant has common factor with 26..."+d);
return false;
}
else
{
